				...
				<div class="container">
					...
					@foreach($posts as $post)
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="{{ $post->thumbnail ? Storage::url($post->thumbnail) : asset('images/no-thumbnail.jpg')}}" alt="">								
							</div>
							<p class="meta">{{$post->created_at->format('d M Y')}} | oleh </a>{{$post->user->name}}</p>
							<a href="#">
							<h5>{{$post->title}}</h5>
						    </a>
						{!!$post->content!!}
					   <a href="{{ route('singlepost', $post->slug) }}" class="details-btn d-flex justify-content-center align-items-center"><span class="details">Details</span><span class="lnr lnr-arrow-right"></span></a>		
					</div>
					@endforeach
					</div>
				</div>	
