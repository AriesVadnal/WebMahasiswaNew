			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" method="GET" action="/siswa">
					<div class="input-group">
						...
						<span class="input-group-btn"><button type="sumbit" class="btn btn-primary">Go</button></span>
					</div>
				</form>
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							@if(auth()->user()->role == 'siswa')
                                {{ auth()->user()->siswa->avatar ? Storage::url(auth()->user()->siswa->avatar) : asset('/images/default.jpg')}}
							@else 
